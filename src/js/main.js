(function ($) {
	...
	if (!Modernizr.touch) {
	    ...
	    pinScene02Tl
	    	...
	    	.set($('#slide02 p'), {text: "You never climb the same mountainnn twice, not even in memory. Memory rebuilds the mountain, changes the weather, retells the jokes, remakes all the moves."})
